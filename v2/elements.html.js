...
export class Element {
  ...
  handleArrayConfig(arr) {
    if (children === null) {
      ...
      this.children = [...arr, new Div(children)];
    }
  }
  ...
  handleObjectConfig(config) {
    ...
    for (let key in config) {
      ...
      // Check if it's a valid prop directly (attributes, DOM props, materia props)
      if (validProps.includes(key)) {
        isValid = true;
      }
      // Check if it's an event with __ prefix (preventDefault)
      ...
      // Check if it's an event with _ prefix (no preventDefault)
      ...
      // Check special patterns
        ...
        key.startsWith("_keydown:") ||
        key.startsWith("__keydown:")
      ) {
        isValid = true;
      }
